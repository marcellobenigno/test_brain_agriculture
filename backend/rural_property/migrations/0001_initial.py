# Generated by Django 5.0.7 on 2024-07-18 20:46
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('created', models.DateTimeField(auto_now_add=True, verbose_name='Criado')),
                ('updated', models.DateTimeField(auto_now=True, verbose_name='Modificado')),
                ('name', models.CharField(choices=[('Algodão', 'Algodão'), ('Café', 'Café'), ('Cana de Açúcar', 'Cana de Açúcar'), ('Milho', 'Milho'), ('Soja', 'Soja'), ('Soja', 'Soja')], max_length=50, verbose_name='Nome da Cultura')),
                ('area_ha', models.DecimalField(decimal_places=3, max_digits=10, verbose_name='Área (ha)')),
                ('rural_property', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='rural_property.ruralproperty')),
            ],
            options={
